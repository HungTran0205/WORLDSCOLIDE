...
##### **Các chỉ số khi mà nhân vật được assign vào room**

- Tốc độ chặt gỗ: số đơn vị gỗ/giây hoặc chu kỳ (ví dụ 5s/10gỗ)
...
- Enchanted wood chance: tỉ lệ thu được gỗ enchant hiếm với bonus đặc biệt (ví dụ 2% base)  - Gỗ enchant có thể cho bonus stat dựa trên STR, DEX, AGI, INT, END, LUK, CHA
  - Bonus stat ngẫu nhiên +1 đến +5 cho mỗi chỉ số phù hợp với item hoặc nhân vật
##### **Các chỉ số khi mà có funiture**
...
#### Các chỉ số khi mà nhân vật được assign vào room
- Tốc độ khai thác: số đơn vị đá/giây hoặc chu kỳ (ví dụ 5s/8đá)
- Durability / tool break chance: tỉ lệ dụng cụ hỏng mỗi lần khai thác (ví dụ 5% base, giảm khi nâng cấp tool)
...
- Phòng chế tạo: xưởng rèn, xưởng phụ kiện, alchemy
...
- Công thức chế tạo weapon: tài nguyên + gold + thời gian
