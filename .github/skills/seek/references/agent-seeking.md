...
Use search subagents when SCALE >= 6 or external tools unavailable.

## How It Works

Spawn multiple subagents via `searchSubagent` tool to search codebase in parallel.
