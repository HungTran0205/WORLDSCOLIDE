...
## Prerequisites
- Activate `tm:ui-ux-pro-max` skill first
- Activate `tm:threejs` skill for 3D and WebGL expertise
- Have `tm:ai-multimodal` skill ready for asset generation

## Initial Research
Run `tm:ui-ux-pro-max` searches:
```bash
python3 .github/skills/ui-ux-pro-max/scripts/search.py "<product-type>" --domain product
python3 .github/skills/ui-ux-pro-max/scripts/search.py "immersive 3d" --domain style
python3 .github/skills/ui-ux-pro-max/scripts/search.py "animation" --domain ux
```

## Workflow Steps

### 1. Create Implementation Plan
Use `tm:ui-ux` + `tm:researcher` subagents:
...
Use `tm:ui-ux` subagent to build:
...
Use `tm:ai-multimodal` skill for:
- Textures and materials
- Skyboxes and environment maps
- Particle sprites
- Video backgrounds

Use `tm:media-processing` skill for:
