...
## Prerequisites
- Activate `tm:ui-ux-pro-max` skill first for design intelligence
- Have `tm:ai-multimodal` skill ready for visual analysis

## Workflow Steps

### 1. Analyze Screenshot Details
Use `tm:ai-multimodal` skill to extract:
...
- Remove backgrounds if needed with `tm:media-processing`
