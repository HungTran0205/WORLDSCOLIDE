...
3. If no plan found → Ask user to specify path or run `/planning` first

## Workflow

### Step 1: Read Plan Files
Read the specs directory:
- `tasks.md` — Overview, phases, dependencies
...
Add `## Red Team Review` section to `tasks.md`.
...
Remind user to run `planning validate` then start implementation.
