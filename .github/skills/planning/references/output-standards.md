...
### YAML Frontmatter (Required for tasks.md)

All `tasks.md` files MUST include YAML frontmatter at the top:
...
- **impacted-areas**: List major components/modules affected
...
**IMPORTANT:** Ask user question for clearing unresolved questions at the end
