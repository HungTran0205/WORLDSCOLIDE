...
- Use `SQLcl` or `oracle` MCP tools to query Oracle database for debugging if needed
- Use `gemini-multimodal` skill for describing details of images, videos, documents, etc. if needed
- Use `gemini-multimodal` skill for generating and editing images, videos, documents, etc. if needed
