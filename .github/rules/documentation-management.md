...
- **Project Roadmap** (`./rules/development-roadmap.md`): Living document tracking project phases, milestones, and progress
- **Project Changelog** (`./rules/project-changelog.md`): Detailed record of all significant changes, features, and fixes
...
### Plan Location
Save plans in `./specs` directory with timestamp and descriptive name.

**Format:** Use naming pattern from `## Naming` section injected by hooks.

**Example:** `specs/251101-1505-authentication-and-profile-implementation/`
#### File Organization
...
│   ├── technical-analysis.md                  # Research findings & analysis
