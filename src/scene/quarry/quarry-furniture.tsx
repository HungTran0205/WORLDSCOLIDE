...
export function QuarryRoomDecor({ cx, cz }: { cx: number; cz: number }) {
  return (
    <group>
      <CaveProp path="/arena/cave/3dprops/p_stonepilla.glb"           position={[cx - 0.6, 0, cz - 3]} targetHeight={3.5} rotY={0.2} />
      <CaveProp path="/arena/cave/3dprops/p_stonepilla.glb"           position={[cx + 2, 0, cz - 3]} targetHeight={2.8} rotY={-0.4} />
      <CaveProp path="/arena/cave/3dprops/p_stonepilla.glb"           position={[cx - 2.4, 0, cz + 0.5]} targetHeight={1.8} rotY={0.8} />
      <CaveProp path="/arena/cave/3dprops/p_stone_pillar_falling.glb" position={[cx + 0.6, 0, cz - 0]} targetHeight={1.0} rotY={0.3} />
