...
const TAVERN: AtmospherePreset = {
  ...
  colorGrade: { hue: 0.06, saturation: 0.05, brightness: 0, contrast: 0.05 },
...
const STONE_QUARRY: AtmospherePreset = {
  ...
  colorGrade: { hue: -0.03, saturation: -0.15, brightness: -0.05, contrast: 0.05 },
  vignette: { offset: 0.5, darkness: 0.65 },
  noise: { opacity: 0.05 },
  fog: { color: '#0f0f14', near: 6, far: 20, enabled: true },
