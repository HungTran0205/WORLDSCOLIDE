...
export interface BiomeConfig {
  ...
  /** Atmospheric particle VFX placements (generated by Map Playground) */
  atmosphericVFX?: AtmosphericVFXPlacement[];
}

/** Atmospheric particle effect placed in the arena (generated by Map Playground) */
export interface AtmosphericVFXPlacement {
  effectId: string;
