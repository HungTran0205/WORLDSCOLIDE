...
export function resetGameState(): void {
  useGameStore.setState({
    ...
    facilities: [
      { type: 'tavern' as const,        level: 0, assignedMemberIds: [], placedSlot: null },
      { type: 'training-yard' as const, level: 0, assignedMemberIds: [], placedSlot: null },
      { type: 'infirmary' as const,     level: 0, assignedMemberIds: [], placedSlot: null },
      { type: 'workshop' as const,      level: 0, assignedMemberIds: [], placedSlot: null },
      { type: 'logging-site' as const,  level: 0, assignedMemberIds: [], placedSlot: null },
      { type: 'stone-quarry' as const,  level: 0, assignedMemberIds: [], placedSlot: null },
    ],
