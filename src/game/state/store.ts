...
export function resetGameState(): void {
  useGameStore.setState({
    ...
    facilities: [
      ...
      { id: 'infirmary' as const,     type: 'infirmary' as const,     level: 0, assignedMemberIds: [], placedSlot: null, woodReserve: null },
      { id: 'workshop' as const,      type: 'workshop' as const,      level: 0, assignedMemberIds: [], placedSlot: null, woodReserve: null },
      { id: 'logging-site' as const,  type: 'logging-site' as const,  level: 0, assignedMemberIds: [], placedSlot: null, woodReserve: null },
      { id: 'stone-quarry' as const,  type: 'stone-quarry' as const,  level: 0, assignedMemberIds: [], placedSlot: null, woodReserve: null },
      { id: 'alchemy-lab' as const,   type: 'alchemy-lab' as const,   level: 0, assignedMemberIds: [], placedSlot: null, woodReserve: null },
    ],
